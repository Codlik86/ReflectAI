...
EXERCISES = {
    ...
    "anxiety": {
        "worry_scale_action": {
            ...
            "intro": (
                "Сначала определим уровень тревоги, затем выберем бережное действие прямо сейчас. "
                "Так мозг получает ощущение контроля и снижается накрутка."
            ),
            "steps": [
                "По шкале 0–10 оцени уровень тревоги прямо сейчас.",
                "Если 0–3: выбери небольшое действие по планам (5–10 минут). Если 4–6: сделай 3 цикла дыхания 4–6 и выбери одно простое дело. Если 7–10: сначала техники успокоения (дыхание/заземление), а уже потом дела.",
                "Запиши одно действие, которое сделаешь в ближайшие 15 минут. По завершении оцени тревогу ещё раз по шкале.",
            ],
        },
        "accept_uncertainty": {
            "title": "Немного больше допуска неопределённости",
            "intro": (
                "Тревога любит «100% гарантий». Мы мягко тренируем допуск неопределённости и возвращаем себе пространство выбора."
            ),
            "steps": [
                "Вспомни ситуацию, где хочется полной определённости.",
                "Сформулируй фразу-допуск: «Я могу не знать всё на 100%, и это нормально. Я сделаю шаг, который сейчас в моих силах».",
                "Выбери маленький шаг, не требующий полной определённости (написать черновик, задать один вопрос, собрать 1 факт). Сделай его.",
            ],
        },
    },
    ...
    "panic_attack": {
        "breath_4_6_now": {
            ...
            "intro": (
                "При панике тело «разгоняется». Длинный выдох помогает снизить уровень возбуждения. "
                "Дышим спокойно: вдох короче, выдох длиннее."
            ),
            "steps": [
                "Если можно — сядь, обопри стопы о пол, положи ладонь на живот.",
                "Вдох на 4 счёта через нос. Живот чуть поднимается.",
                "Выдох на 6 счётов через рот, как через трубочку. Плечи мягкие.",
                "Повтори 6–10 циклов. Если закружилась голова — сделай паузу на 10–15 секунд и продолжи.",
            ],
        },
        "orienting_5_4_3_2_1": {
            "title": "Ориентирование 5-4-3-2-1",
            "intro": (
                "Возвращаемся в «здесь-и-сейчас» через органы чувств — мозг получает сигнал безопасности."
            ),
            "steps": [
                "Назови 5 вещей, которые видишь вокруг.",
                "Назови 4 звука, которые слышишь (или тишину).",
                "Назови 3 тактильных ощущения в теле (опора, одежда, температура).",
                "Назови 2 запаха (или просто глубоко вдохни).",
                "Назови 1 вкус (или отметь «нейтрально»). Сделай длинный спокойный выдох.",
            ],
        },
        "panic_map": {
            "title": "Карта паники (на будущее)",
            "intro": (
                "После эпизода полезно записать заметки: так ты узнаешь свои триггеры и рабочие способы помощи себе."
            ),
            "steps": [
                "Что было перед началом (место, люди, мысли, стимулы)?",
                "Что происходило в теле (сердцебиение, дыхание, температура и т.д.)?",
                "Что помогло хотя бы немного (позиция тела, дыхание, вода, разговор, музыка и др.)?",
                "Что сделаю в следующий раз в первые 2 минуты? Запиши простой план из 2–3 шагов.",
            ],
        },
    },
