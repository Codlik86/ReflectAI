# scripts/broadcast_gift_2d_march8.py
import os
import asyncio
...
GIFT_DAYS = 2  # Изменено с 3 на 2
GIFT_PLAN = "gift_march8_2d"  # Изменено название плана
GIFT_TIER = "gift"
GIFT_STATUS = "active"

MESSAGE = (
    "🌷 С 8 Марта!\n\n"
    "В этот день хочется сказать вам главное: вы не одни.\n"
    "Мы знаем, как иногда бывает непросто — и как важно, чтобы кто-то был рядом, даже молча.\n\n"
    "Дарим вам +2 дня подписки бесплатно.\n\n"
    "Ваша команда «Помни» 💐"
)
...
async def main():
    ...
    async with Session() as session:
        ...
        print(f"March 8 gift: found users: {len(user_ids)}")
    ...
    print("March 8 gift: subscriptions updated")
    print("March 8 gift: broadcasting...")
